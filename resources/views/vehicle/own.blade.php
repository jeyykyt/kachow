<div data-isloading="false">
    ...
    <div class="header-row-center mb-4" style="display: flex; align-items: center; justify-content: center;">
        ...
        @php
            // If the controller passed us hasTrims=true, then “Back” → Trim;
            // otherwise, “Back” → Model.
            $backRoute = $hasTrims ?? false
                ? route('make.trims', [
                      'make'  => $make->id,
                      'year'  => $selectedYear,
                      'model' => $selectedModel,
      ...
      <span class="arrow-wrapper">
        <svg width="24" height="24" viewBox="0 0 24 24" style="transform: rotate(180deg);">
            <g fill="none" fill-rule="evenodd">
                <path stroke="#124476" stroke-width="2" d="M14 20.485L22.485 12h0L14 3.515"/>
                <path stroke="#124476" stroke-width="2" stroke-linecap="square" d="M1 12.5h20"/>
            </g>
        </svg>
      </span>
