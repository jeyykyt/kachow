...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.querySelectorAll('#step-incidents .left-btn, #step-incidents .header-back-abs').forEach(function(btn) {
            btn.addEventListener('click', function() {
        ...
        // “Next” in #step-incidents
        if (stepIncidents) {
        stepIncidents.querySelector('.right-btn').addEventListener('click', function() {
        ...
        // ────────────────────────────────────────────────
        // detailAccident: Back → always #step-incidents
        //               Next → either #step-detailTicket, #step-detailDui, or #step-name
        // ────────────────────────────────────────────────
        if (stepAccident) {
        // Back buttons
        stepAccident.querySelectorAll('.header-back-abs, .left-btn').forEach(function(btn) {
        btn.addEventListener('click', function() {
        ...
        // ────────────────────────────────────────────────
        // detailTicket: Back → if (accident==='yes') → detailAccident, else → #step-incidents
        //              Next → either #step-detailDui or #step-name
        // ────────────────────────────────────────────────
        if (stepTicket) {
        // Back buttons
        stepTicket.querySelectorAll('.header-back-abs, .left-btn').forEach(function(btn) {
        btn.addEventListener('click', function() {
        ...
        // ────────────────────────────────────────────────
        // detailDui: Back → if (ticket==='yes') → detailTicket
        //                     else if (accident==='yes') → detailAccident
        //                     else → #step-incidents
        //           Next → #step-name
        // ────────────────────────────────────────────────
        if (stepDui) {
        // Back buttons
        stepDui.querySelectorAll('.header-back-abs, .left-btn').forEach(function(btn) {
        btn.addEventListener('click', function() {
...
// (2) Now handle stepName’s Back & Next:
        ...
        if (stepNumber) {
            ...
            const btnBackNumberList = stepNumber.querySelectorAll('.header-back-abs');
            btnBackNumberList.forEach(function(btn) {
                btn.addEventListener('click', function() {
